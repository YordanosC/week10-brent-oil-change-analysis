...
const EventImpact = () => {
  ...
  const percentageChangeOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Percentage Changes in Oil Prices",
      },
    },
  };
  ...
  const priceTrendOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Brent Oil Price Trends Around Events",
      },
      annotation: {
  ...
  return (
    <div>
      ...
      <Table striped>
        <thead>
          <tr>
            <th> Event </th> <th> Date </th> <th> T - Statistic </th>{" "}
            <th> P - Value </th>{" "}
          </tr>{" "}
        </thead>{" "}
        <tbody>
          ...
          {eventData.map((event, index) => (
            <tr key={index}>
              <td> {event.Event} </td> <td> {event.Date} </td>{" "}
              <td>
                {" "}
